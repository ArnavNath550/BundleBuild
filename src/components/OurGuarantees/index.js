...
import './ourGuarantees.css'

const OurGuarantees = () => {
  return (
    <div className="our-guarantees-container" id="ourGuaranteesSection">
        <div className="section-step-icon">            
                <svg width="122" height="247" viewBox="0 0 122 247" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="124.5" width="122" height="122" rx="61" fill="url(#paint0_linear_3_187)"/>
                ...
                <path d="M60.5 126.5V0" stroke="url(#paint1_linear_3_187)" stroke-width="5"/>
                <defs>
        ...
        <div className="mission-container">
            <div className="mission-container-heading">
                What do we Guarantees       
            </div>
            <div className="mission-container-description">
                Here’s what we won’t skip, on building your website.
            </div>
        </div>
        <section className="our-guaruntee-pane">
            <div className="our-guaruntee-pane-left">
                <img src="assets/img/pane_images/guarantees/first_draft_pane_image.svg" class="our-guaruntee-screen-img fade-in-bottom" />
            </div>
        ...
        <section className="our-guaruntee-pane">
            ...
            <div className="our-guaruntee-pane-right">
                <img src="assets/img/pane_images/guarantees/beautiful_pane_image.svg" class="our-guaruntee-screen-img fade-in-bottom" />
            </div>
        </section>
        <section className="our-guaruntee-pane">
            <div className="our-guaruntee-pane-left">
                <img src="assets/img/pane_images/guarantees/revisions_pane_image.svg" class="our-guaruntee-screen-img fade-in-bottom" />
            </div>
            <div className="our-guaruntee-pane-right">
                <div class="screen-text text-visible">
